...
## [AI Software Engineer: Programming with Trust](paper_24.md)
...
## [AgentArmor: Enforcing Program Analysis on Agent Runtime Trace to Defend Against Prompt Injection](paper_18.md)
...
## [Agentic Program Verification](paper_27.md)
...
## [Are “Solved Issues” in SWE-bench Really Solved Correctly?](paper_16.md)
...
## [Automated Static Vulnerability Detection via a Holistic Neuro-symbolic Approach](paper_19.md)
...
## [BountyBench: Dollar Impact of AI Agent Attackers and Defenders on Real-World Cybersecurity Systems](paper_23.md)
...
## [C2SaferRust: Transforming C Projects into Safer Rust with NeuroSymbolic Techniques](paper_30.md)
...
## [CRUST-Bench: A Comprehensive Benchmark for C-to-safe-Rust Transpilation](paper_7.md)
...
## [Can LLMs Formally Reason as Abstract Interpreters for Program Analysis?](paper_17.md)
...
## [Can LLMs Reason About Program Semantics? A Comprehensive Evaluation of LLMs on Formal Specification Inference](paper_12.md)
...
## [Challenges and Paths Towards AI for Software Engineering](paper_1.md)
...
## [ClassInvGen: Class Invariant Synthesis using Large Language Models](paper_15.md)
...
## [Combining Large Language Models with Static Analyzers for Code Review Generation](paper_14.md)
...
## [CyberGym: Evaluating AI Agents' Cybersecurity Capabilities with Real-World Vulnerabilities at Scale](paper_22.md)
...
## [Evaluating the Effectiveness of Small Language Models in Detecting Refactoring Bugs](paper_13.md)
- **Authors**: Rohit Gheyi, Marcio Ribeiro, Jonhnanthan Oliveira
...
## [Fixing 7,400 Bugs for 1$: Cheap Crash-Site Program Repair](paper_20.md)
...
## [From System 1 to System 2: A Survey of Reasoning Large Language Models](paper_26.md)
...
## [Hierarchical Repository-Level Code Summarization for Business Applications Using Local LLMs](paper_29.md)
...
## [Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities](paper_21.md)
...
## [Is Your Benchmark (Still) Useful? Dynamic Benchmarking for Code Language Models](paper_10.md)
...
## [KNighter: Transforming Static Analysis with LLM-Synthesized Checkers](paper_11.md)
...
## [LAMD: Context-driven Android Malware Detection and Classification with LLMs](paper_5.md)
...
## [LLM-Based Repair of Static Nullability Errors](paper_31.md)
...
## [Language Models for Code Optimization: Survey, Challenges and Future Directions](paper_6.md)
...
## [Large Language Model powered Symbolic Execution](paper_28.md)
...
## [Minimizing False Positives in Static Bug Detection via LLM-Enhanced Path Feasibility Analysis](paper_9.md)
...
## [PoCGen: Generating Proof-of-Concept Exploits for Vulnerabilities in Npm Packages](paper_32.md)
...
## [Prompting Large Language Models to Tackle the Full Software Development Lifecycle: A Case Study](paper_2.md)
...
## [QLCoder: A Query Synthesizer For Static Analysis of Security Vulnerabilities](paper_25.md)
...
## [SecVulEval: Benchmarking LLMs for Real-World C/C++ Vulnerability Detection](paper_3.md)
...
## [The Hitchhiker's Guide to Program Analysis, Part II: Deep Thoughts by LLMs](paper_4.md)
...
## [Training Language Models to Generate Quality Code with Program Analysis Feedback](paper_8.md)
